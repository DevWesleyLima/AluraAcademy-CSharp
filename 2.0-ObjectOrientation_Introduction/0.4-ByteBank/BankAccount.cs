...
namespace _0._4_ByteBank
{
    public class BankAccount
    {
        ...
        public BankAccount(Customer holder, int branchNumber, int number, double initialBalance, double depositValue, double withdrawalValue, double amountValue, double transferedAmountValue, double receivedAmountValue)
        {
            this.holder = holder;
